...
-- /home/luis/Cursos/baseDeDatos_gc/pracica/practicaDesarrolladaGit/e-market/emarket.sql
--
-- Create schema cdf_EMarket
--

DROP DATABASE IF EXISTS cdf_EMarket;
CREATE DATABASE cdf_EMarket;
USE cdf_EMarket;
